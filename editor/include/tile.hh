...
public:
  ...
  OneDir(u32 id) : Tile(TileType::OneDir, id), dir(Direction::Up) {}
...
public:
  // construct a new portal, by default by default is unlinked to another
  // portal.
  Portal(u32 id) : Tile(TileType::Portal, id), linked(false) {}
